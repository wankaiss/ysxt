...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>医疗机构及药店特定中药饮片统计数据查询</title>
...
<body>
	...
	<form action="zyyp_totalStatisticsQuery.action" method="post" name="form" id="chooseForm" target="_self">
	...
	<script type="text/javascript">
		...
		function query(){
			...
			*/
			$("#start").val(0);
			form.action = "zyyp_totalStatisticsQuery.action";
			form.target = '_self';
			form.submit();
		}
		//日期校验
		...
		function exportExcel(){
			alert("EXCEL导出中请耐心等待...");
			form.action = "zyyp_exportExcelSingleLine.action?condition.divId=2";
			form.target = '_self';
			form.submit();
		}
		...
		function showDemo(){
			var params = "&condition.startDate="+encodeURI(encodeURI($("#tempStart").val()))+"&condition.endDate="+encodeURI(encodeURI($("#tempEnd").val()))
				...
				+"&condition.akb022="+$("#akb022").val()+"&condiiton.ydIds="+$("#ydIds").val()
			...
			window.open('zyyp_showHosYdDemo.action?params='+params,"医疗机构及药店特定中药饮片统计数据查询",wndFeatures);
		}
	</script>
</body>
</html>
