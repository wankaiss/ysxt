...
<body>
				...
				<div id="div1">
					<table class="date_tab" id="trId" width="95%" border="0" cellspacing="0" cellpadding="0">
						...
						<s:else>
							...
							<tr>
								<td style="text-align: center;">&gt;0and&lt;=15%</td>
								<td><input type="text" name="condition.qzz"/></td>
							</tr>
							<tr>
								<td style="text-align: center;">&gt;15%and&lt;=35%</td>
								<td><input type="text" name="condition.qzz"/></td>
							</tr>
							<tr>
								<td style="text-align: center;">&gt;35%and&lt;=50%</td>
								<td><input type="text" name="condition.qzz"/></td>
							</tr>
							<tr>
				...
				<div style="display: none;" id="div2">
					<table class="date_tab" id="trId" width="95%" border="0" cellspacing="0" cellpadding="0">
						...
						<s:else>
							...
							<tr>
								<td style="text-align: center;">&gt;35%and&lt;=50%</td>
								<td><input type="text" id="temp4"/></td>
							</tr>
							<tr>
								<td style="text-align: center;">&gt;50%</td>
								<td><input type="text" id="temp5"/></td>
							</tr>
						</s:else>
					</table>
					<div style="text-align: center;">
	...
	<script type="text/javascript">
		...
		//查询
		function query(){
			form.action = "hztj_singleMedPay.action?condition.divId="+divId+"&condition.tcdm="+$("#tcdm").val();
			form.target="_self";
			form.submit();
		}
		//分数修改
		...
		function saveData(){
			...
			$.ajax({
				url:"hztj_saveParameterSingleMed.action",
				cache:false,
				type:"post",
				data:{
					tempqxm:tempqxm,
		...
		function updateScore(){
			...
			var k = window.showModalDialog('hztj_updateScore.action?condition.gzbz='+gzbz+"&condition.tcdm="+temptcdm+"&condition.divId="+divId+"&condition.qzjb=7"+"&condition.qzdm="+qzdm,null,wndFeatures);
			var tt = k.split(",");
			$("#gzbz").val(tt[1]);
			if(tt[0]){
				//修改成功重新加载页面
