...
<body>
	...
	<form action="ydfx_hosAggregateAnalysis.action" method="post" name="form" id="chooseForm" target="_self">
		<div class="dateBox winscroll"  style="clear: both;">
			<div class="tab_nr">
							...
							<td>
								<div class="gray_k">
									<span class="fL" style="padding-left:0px;">
										...
										<em class="pL20">
										    <input type="text" name="condition.startDate" id="startDate" class="iconDate" onchange="select_View_Date();"  style="width:128px;"/> 
				...
				<div class="wd-content-box" style="overflow-x:srolll; overflow-y:hidden; height:475px">
	...
	<script type="text/javascript">
		...
		function query(){
			showBlock();
			$("#start").val(0);
			form.action = "ydfx_hosAggregateAnalysis.action";
			form.target='_self';
			form.submit();
		}
