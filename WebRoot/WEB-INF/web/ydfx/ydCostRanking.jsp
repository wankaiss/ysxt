...
<body>
	...
	<form action="hztj_ydCostRanking.action" method="post" name="form" id="chooseForm" target="_self">
				...
				<div class="wd-content-box">
					<table class="date_tab" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>排名数量：</td>
							<td style="text-align: left;">
								<input type="text" name="condition.pm" value="${condition.pm }"/>
							</td>
	...
	$(document).ready(function(){
		...
		function exportExcel(){
			alert("正在导出中......请稍后!");
			form.action = "ydfx_exportExcelYdCostRanking.action";
			form.target='_self';
			form.submit();
		}
	</script>
