(function(a, b) {
	...
	var H = a.document,
		...
		K = function() {
			...
			}), z = d.uaMatch(y), z.browser && (d.browser[z.browser] = !0, d.browser.version = z.version), d.browser.webkit && (d.browser.safari = !0), i.test(" ") && (j = /^[\s ]+/, k = /[\s ]+$/), g = d(H), H.addEventListener ? B = function() {
	...
	bz.optgroup = bz.option, bz.tbody = bz.tfoot = bz.colgroup = bz.caption = bz.thead, bz.th = bz.td, K.support.htmlSerialize || (bz._default = [1, "div<div>", "</div>"]), K.fn.extend({
		...
		clean: function(a, b, c, d) {
			...
			(i = a[h]) != null; h++) {
				...
				var p;
				if (!K.support.appendChecked) if (i[0] && typeof(p = i.length) == "number") for (g = 0; g < p; g++) r(i[g]);
				else r(i);
	...
	function e(b, e) {
		...
		d || (d = f), h.length > 1 && (h = a(e.items, b)), e.size > 1 && (e.circular = !1), a.extend(f, {
			...
			seekTo: function(b, c, k) {
				...
				return i = b, d = f, c === undefined && (c = e.speed), h.animate(n, c, e.easing, k ||
				function() {
					g.trigger("onSeek", [b])
				}), f
			}
